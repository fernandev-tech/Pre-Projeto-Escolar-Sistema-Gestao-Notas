...
export default function HorarioInformatica11() {
  const [turno, setTurno] = useState<"manha" | "tarde">("manha");

  const horarioManha = [
    { dia: "Segunda", a1: "Matemática", a2: "TLP", a3: "SEAC", a4: "Física" },
    { dia: "Terça", a1: "Português", a2: "Inglês", a3: "Química", a4: "DT" },
    { dia: "Quarta", a1: "TLP", a2: "Matemática", a3: "ET", a4: "SEAC" },
    { dia: "Quinta", a1: "Física", a2: "Química", a3: "DT", a4: "Empreendedorismo" },
    { dia: "Sexta", a1: "TLP", a2: "FAI", a3: "SEAC", a4: "Matemática" },
  ];

  const horarioTarde = [
    { dia: "Segunda", a1: "TLP", a2: "Matemática", a3: "SEAC", a4: "Física" },
    { dia: "Terça", a1: "Inglês", a2: "Português", a3: "Química", a4: "DT" },
    { dia: "Quarta", a1: "Matemática", a2: "TLP", a3: "ET", a4: "SEAC" },
    { dia: "Quinta", a1: "Física", a2: "Química", a3: "Empreendedorismo", a4: "DT" },
    { dia: "Sexta", a1: "TLP", a2: "FAI", a3: "SEAC", a4: "Matemática" },
  ];
    ...
    <div className="p-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          Curso: <strong>Informática</strong> | Classe: <strong>11ª</strong>
        </p>
      </div>
